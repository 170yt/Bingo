    ...
    public void checkItem(Player player, Material material) {
        ...
        if (Main.getInstance().getConfig().getBoolean("settings.isTeamGame")) {
            ...
            if (missingMaterialsTeam.get(getPlayerTeamSTRING(player)).contains(material)) {
                ...
                Bukkit.broadcastMessage(ChatColor.GOLD + getPlayerTeamSTRING(player) + " got " + material.toString().toLowerCase());
            ...
            if (missingMaterialsPlayer.get(player.getUniqueId()).contains(material)) {
                ...
                Bukkit.broadcastMessage(ChatColor.GOLD + player.getName() + " got " + material.toString().toLowerCase());

                if (missingMaterialsPlayer.get(player.getUniqueId()).isEmpty()) {
                    Bukkit.broadcastMessage(ChatColor.GOLD + player.getName() + " finished!");
                    Main.getInstance().logToFile(player.getName() + " finished!");
                    finishGame();
                }
            }
        }
